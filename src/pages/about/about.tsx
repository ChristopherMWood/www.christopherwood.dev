  ...
  return (
    <main>
      <div id="about-page" className="page-container">
        ...
        <p>
          <b className="p-section-title">About This Site: </b> This site serves a dual purpose. The visual aspect, built using React.js, is aimed at being a living resume of sorts. But, on the backend, it's acting as the API for projects I'm working on. I had the immediate need for an API recently and decided to expand it to be a general purpose backend for any future needs. The front-end source code can be found <a href="https://github.com/ChristopherMWood/christopherwood.dev-frontend" target="_blank" rel="noopenerm noreferrer">here</a> and the backend source code can be found <a href="https://github.com/ChristopherMWood/christopherwood.dev-backend" target="_blank" rel="noopenerm noreferrer">here</a>.
        </p>
      </div>
    </main>
  );
